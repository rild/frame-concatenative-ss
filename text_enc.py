...
def raw_to_kana(text):
    return mix_pronunciation(text, p=1)

def kana_to_roma(text):
    _converter = KanaConverter.KanaConverter()
    return _converter.kana_to_roma(text)
